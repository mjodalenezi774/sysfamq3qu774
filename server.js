...
const youtube = new YouTube("AIzaSyDaD4Q43ofekIC4gmYJ9EGgGYad4wCG5XI"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyDaD4Q43ofekIC4gmYJ9EGgGYad4wCG5XI"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@344831359677890560>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content === "brb") {
    message.channel.send("**:heart:take your time:heart:**");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "اكثر كلمه يقولها سلطان") {
    message.channel.send(" تفهمـ تفهمـ:heart:");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "اكثر كلمه يقولها دردر") {
    message.channel.send("يـاسطـااه");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "اكثر كلمه يقولها فهد") {
    message.channel.send(" د ز امـهـاا ");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "اكثر كلمه يقولها جسر") {
    message.channel.send(" يرجال صبلي حليبـ ");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content === "اكثر كلمه يقولها محمد") {
    message.channel.send("🤪 تبي أفكـ فيس كام؟ ");
    message.channel.sendFile("");
  }
});
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setby")) {
    ...
    if (
      !message.guild.member(message.author.id).hasPermission("#𝖶𝖤𝖫𝖢𝖮𝖬𝖤f")
    )
    ...
    client.on("guildMemberAdd", member => {
      ...
      var channel = member.guild.channels.find(gg => gg.name === "famous-logs"); //// تعديل اساسي
      if (!channel) return;
...
client.on("guildMemberAdd", async member => {
  ...
  if (channel) {
    ...
    const wlcImage = await fsn.readFile("./welcom13.png"); //اسم الصورة
    ...
    //Avatar
    var imageX = 112; //X coordinate
    var imageY = 134; //Y coordinate
    var imageRadius = 95; //نصف قطر الصورة الدائرية

    //Member Name
    var nameSize = "18pt"; //حجم خط الاسم
    var nameKind = "Source Sans Pro (OT1)"; //نوع خط الاسم
    var nameColor = "#e0e0e2"; //لون خط الاسم

    //Name Position
    var nameX = 320; //position x
    var nameY = 180; //position y
